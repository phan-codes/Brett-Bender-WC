...
const NavLinks = ({ isMenuShown, hideMenu }: NavLinkProp) => {
	return (
		<div className="w-[80%] flex justify-center items-center">
			<div className="flex justify-between items-center w-[80%] py-1 px-5">
				...
				<div
					className={`absolute z-50 min-w-full h-fit flex justify-center top-[70px]  right-0 items-center flex-col bg-white dark:bg-gradient-to-r dark:from-[black] dark:via-[#000207] dark:to-black rounded-md lg:hidden shadow-sm dark:shadow-gray-900 ${
